...
navbar = dbc.NavbarSimple(
    brand='US Top 10% Share of Wealth',
    brand_href='/',
    children=[
...
footer = dbc.Container(
    dbc.Row(
        dbc.Col(
            html.P(
                [
                    html.Span('Andrea Christelle', className='mr-2'),
                    html.A(html.I(className='fas fa-envelope-square mr-1'), href='mailto:<andrea>@<sedonaphilosophy>.com'),
                    html.A(html.I(className='fab fa-github-square mr-1'), href='https://github.com/<supai-red>/<wealth_top_decile_USA>'),
                    html.A(html.I(className='fab fa-linkedin mr-1'), href='https://www.linkedin.com/in/andrea-christelle-100aa230/'),
                    html.A(html.I(className='fab fa-twitter-square mr-1'), href='https://twitter.com/<SedonaAndrea>'),
                ],
                className='lead'
            )
        )
